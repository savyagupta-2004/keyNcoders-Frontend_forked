    ...
    <div className="flex flex-col md:flex-row justify-between items-center p-4 text-black">
      <div className="flex flex-col sm:flex-row sm:gap-4 gap-2">
        ...
        >
          ...
          <option value="hard" className="text-red-600">
            Hard
          </option>
        </select>
        <select
        ...
        >
          ...
          <option value="array" className="text-black">
            Array
          </option>
          <option value="linkedlist" className="text-black">
            Linked List
          </option>
          <option value="tree" className="text-black">
            Tree
          </option>
          <option value="graph" className="text-black">
            Graph
          </option>
        </select>
        <select
          ...
          className="px-4 py-2 border-gray-200 border-2 rounded-md dark:text-white dark:bg-transparent"
        >
          <option value="unsolved" className="text-red-600">
            Unsolved
          </option>
